...
public class MotionProfileController {
	...
	*/
	...
	double pi = 3.141596535897932384626;
	double ticksPerRotationHighGear = 2816;
	...
	public double inchesToTicksHG(double distance){
	...
	*/
	public double calculatePID(double setpoint, double current){
		double setpoint_ticks = inchesToTicksHG((setpoint/12));
